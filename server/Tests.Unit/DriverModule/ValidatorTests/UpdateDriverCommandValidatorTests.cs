...
[TestClass]
[TestCategory("Driver - UpdateDriverCommandValidator Unit Tests")]
public class UpdateDriverCommandValidatorTests
{
    private UpdateDriverCommandValidator _validator = null!;
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { DriverId = Guid.Empty };
        ...
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.DriverId) &&
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Name = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.Name) &&
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Name = "A" };
    ...
    public void Should_Fail_When_Name_Is_Too_Long()
    {
        ...
        UpdateDriverCommand command = CreateValidCommand() with { Name = longName };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Name = "Joao 123" };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Email = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.Email) &&
    ...
    public void Should_Fail_When_Email_Is_Too_Long()
    {
        ...
        UpdateDriverCommand command = CreateValidCommand() with { Email = tooLongEmail };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Email = "email-invalido" };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { PhoneNumber = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.PhoneNumber) &&
    ...
    public void Should_Fail_When_PhoneNumber_Is_Too_Long()
    {
        ...
        UpdateDriverCommand command = CreateValidCommand() with { PhoneNumber = tooLongPhone };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { PhoneNumber = "47-99999-9999" };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Cpf = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.Cpf) &&
    ...
    public void Should_Fail_When_Cpf_Is_Too_Long()
    {
        ...
        UpdateDriverCommand command = CreateValidCommand() with { Cpf = tooLongCpf };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Cpf = "1234567890" };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Cnh = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.Cnh) &&
    ...
    public void Should_Fail_When_Cnh_Is_Too_Long()
    {
        ...
        UpdateDriverCommand command = CreateValidCommand() with { Cnh = tooLongCnh };
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { Cnh = "ABC123" };
    ...
    public void Should_Fail_When_CnhExpirationDate_Is_In_The_Past()
    {
        ...
        UpdateDriverCommand command = CreateValidCommand() with { CnhExpirationDate = yesterday };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.CnhExpirationDate) &&
    ...
    {
        // arrange
        UpdateDriverCommand command = CreateValidCommand() with { ClientId = Guid.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(error =>
            error.PropertyName == nameof(UpdateDriverCommand.ClientId) &&
