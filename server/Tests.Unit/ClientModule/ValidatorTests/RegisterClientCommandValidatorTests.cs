...
[TestClass]
[TestCategory("Client - RegisterClientCommandValidator Unit Tests")]
public class RegisterClientCommandValidatorTests
{
    private RegisterClientCommandValidator _validator = null!;
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Name = string.Empty };
        ...
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Name) &&
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Name = "A" };
    ...
    public void Should_Fail_When_Name_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Name = longName };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Name = "João123" };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Email = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Email) &&
    ...
    public void Should_Fail_When_Email_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Email = longEmail };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Email = "invalid-email" };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { PhoneNumber = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.PhoneNumber) &&
    ...
    public void Should_Fail_When_PhoneNumber_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { PhoneNumber = longPhone };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { PhoneNumber = "11-98765-4321" };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Cpf = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Cpf) &&
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Cpf = "123" };
    ...
    public void Should_Fail_When_Individual_Client_Has_Cpf_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Cpf = longCpf };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Rg = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Rg) &&
    ...
    public void Should_Fail_When_Individual_Client_Has_Rg_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Rg = longRg };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Rg = "12.345.678-9" };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Cnh = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Cnh) &&
    ...
    public void Should_Fail_When_Individual_Client_Has_Cnh_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Cnh = longCnh };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Cnh = "ABC12345678" };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidLegalEntityCommand() with { Cnpj = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Cnpj) &&
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidLegalEntityCommand() with { Cnpj = "123456" };
    ...
    public void Should_Fail_When_LegalEntity_Client_Has_Cnpj_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidLegalEntityCommand() with { Cnpj = longCnpj };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { State = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.State) &&
    ...
    public void Should_Fail_When_State_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { State = longState };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { City = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.City) &&
    ...
    public void Should_Fail_When_City_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { City = longCity };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { District = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.District) &&
    ...
    public void Should_Fail_When_District_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { District = longDistrict };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Street = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Street) &&
    ...
    public void Should_Fail_When_Street_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Street = longStreet };
    ...
    {
        // arrange
        RegisterClientCommand command = CreateValidIndividualCommand() with { Number = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterClientCommand.Number) &&
    ...
    public void Should_Fail_When_Number_Is_Too_Long()
    {
        ...
        RegisterClientCommand command = CreateValidIndividualCommand() with { Number = longNumber };
