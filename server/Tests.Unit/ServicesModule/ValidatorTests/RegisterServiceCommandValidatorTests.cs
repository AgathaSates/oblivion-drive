...
[TestClass]
[TestCategory("Service - RegisterServiceCommandValidator Unit Tests")]
public class RegisterServiceCommandValidatorTests
{
    private RegisterServiceCommandValidator _validator = null!;
    ...
    public void Setup()
    {
        _validator = new RegisterServiceCommandValidator();
    }
    ...
    public void Should_Fail_When_Name_Is_Empty()
    {
        ...
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterServiceCommand.Name) &&
    ...
    public void Should_Fail_When_Price_Is_Less_Than_Or_Equal_To_Zero()
    {
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterServiceCommand.Price) &&
    ...
    public void Should_Fail_When_ChargeType_Is_Invalid()
    {
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(RegisterServiceCommand.ChargeType) &&
