...
[TestClass]
[TestCategory("BillingPlan - UpdateBillingPlanCommandValidator Unit Tests")]
public class UpdateBillingPlanCommandValidatorTests
{
    private UpdateBillingPlanCommandValidator _validator = null!;
    ...
    public void Setup()
    {
        _validator = new UpdateBillingPlanCommandValidator();
    }
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { BillingPlanId = Guid.Empty };
        ...
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.BillingPlanId) &&
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { Name = string.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.Name) &&
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { Name = "A" };
    ...
    public void Should_Fail_When_Name_Is_Too_Long()
    {
        ...
        UpdateBillingPlanCommand command = CreateValidCommand() with { Name = longName };
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { VehicleGroupId = Guid.Empty };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.VehicleGroupId) &&
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { DailyPlanDailyRate = 0m };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.DailyPlanDailyRate) &&
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with
        {
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { DailyPlanPricePerKilometer = -1m };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.DailyPlanPricePerKilometer) &&
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { ControlledPlanDailyRate = 0m };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.ControlledPlanDailyRate) &&
    ...
    public void Should_Fail_When_ControlledPlanExtraPricePerKilometer_Is_Negative()
    {
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.ControlledPlanExtraPricePerKilometer) &&
    ...
    {
        // arrange
        UpdateBillingPlanCommand command = CreateValidCommand() with { FreePlanDailyRate = 0m };
        ...
        Assert.IsFalse(result.IsValid);
        Assert.IsTrue(result.Errors.Any(e =>
            e.PropertyName == nameof(UpdateBillingPlanCommand.FreePlanDailyRate) &&
